...
class ColorMaps:
    @classmethod
    def seismic_blwr(cls, version=1):
        """
        Seismic black-white-red colormap.

        Version 1 equals Matplotlib's standard 'RdGy', while version 2 has a
        brighter 'red' component.
        """
        if version == 1:
    ...
    @classmethod
    def seismic_blwr_r(cls, version=1):
        """
        ...
        brighter 'red' component.
        """
        return cls.seismic_blwr(version=version).reversed()
    ...
    @classmethod
    def seismic_bwr_r(cls):
        """Reversed seismic blue-white-red colormap."""
        return cls.seismic_bwr().reversed()

    @classmethod
    def bwr(cls, alpha=0.5):
        """
        Blue-white-red colormap with optional transparency in the center.

        alpha is the transparency value between 0 and 1.
        """
    ...
    def opendtect_r(cls):
        ...
        return cls.opendtect().reversed()

    @classmethod
    def seismic_clip(cls):
    ...
    @classmethod
    def seismic_clip_r(cls):
        """Reversed seismic colormap with clipped extreme values."""
        return cls.seismic_clip().reversed()
...
class DataViewer:
    def __init__(self, root):
        ...
        self.cmap_calls = ["seismic", "Greys", ColorMaps.seismic_blwr(version=2), ColorMaps.seismic_blwr_r(version=2),
                     ColorMaps.seismic_bwr(), ColorMaps.seismic_bwr_r(), ColorMaps.opendtect(), ColorMaps.opendtect_r(),
                     ColorMaps.seismic_clip(), ColorMaps.seismic_clip_r(), ColorMaps.banded(), ColorMaps.banded_r(),
                     ColorMaps.spectrum(), ColorMaps.spectrum_r()]
        # status updates
